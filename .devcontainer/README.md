...
```
speakeasy generate usage -s http://127.0.0.1:8000/openapi.json -l python -i {INPUT_OPERATION_ID} -o ./samples
```

- To generate samples for an entire namespace (like a tag or group name), use:

```
speakeasy generate usage -s http://127.0.0.1:8000/openapi.json -l python -n {INPUT_TAG_NAME} -o ./samples
```
