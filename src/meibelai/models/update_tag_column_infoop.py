...
class UpdateTagColumnInfoRequestTypedDict(TypedDict):
    datasource_id: str
    table_name: str
    column_name: str
    customer_id: str
    r"""Customer ID"""
    update_tag_column_request: UpdateTagColumnRequestTypedDict


class UpdateTagColumnInfoRequest(BaseModel):
    ...
    update_tag_column_request: Annotated[
        UpdateTagColumnRequest,
