...
class SendChatMessageStreamBlueprintInstanceIDChatStreamPostRequestTypedDict(TypedDict):
    blueprint_instance_id: str
    chat_message_request: ChatMessageRequestTypedDict


class SendChatMessageStreamBlueprintInstanceIDChatStreamPostRequest(BaseModel):
