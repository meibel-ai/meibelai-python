...
from .agentidentitycontext import AgentIdentityContext, AgentIdentityContextTypedDict
...
ScoreTypedDict = TypeAliasType("ScoreTypedDict", Union[float, int])


Score = TypeAliasType("Score", Union[float, int])


class ScoringJobRecordTypedDict(TypedDict):
    r"""ScoringJobRecord"""

    job_id: str
    agent_identity_context: AgentIdentityContextTypedDict
    ...
    module: str
    scoring_config: ConfidenceScoringConfigTypedDict
    ...
    r"""ScoringStatus"""
    score: NotRequired[Nullable[ScoreTypedDict]]
...
class ScoringJobRecord(BaseModel):
    ...
    score: OptionalNullable[Score] = UNSET

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["score"])
        nullable_fields = set(["score"])
