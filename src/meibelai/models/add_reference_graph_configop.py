...
class AddReferenceGraphConfigRequest1TypedDict(TypedDict):
    datasource_id: str
    add_reference_graph_config_request: AddReferenceGraphConfigRequestTypedDict
    customer_id: NotRequired[Nullable[str]]
    r"""Customer ID"""


class AddReferenceGraphConfigRequest1(BaseModel):
    datasource_id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]

    add_reference_graph_config_request: Annotated[
        AddReferenceGraphConfigRequest,
