...
class Completions(BaseSDK):
    ...
    def create_stream(
        ...
        *,
    ...
    ) -> eventstreaming.EventStream[models.CreateStreamResponseBody]:
        r"""Create Completion Stream
        ...
        req = self._build_request(
            method="POST",
            path="/completions/create/stream",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "text/event-stream"):
            return eventstreaming.EventStream(
                http_res,
                lambda raw: utils.unmarshal_json(raw, models.CreateStreamResponseBody),
                sentinel="[DONE]",
            )
    ...
    async def create_stream_async(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> eventstreaming.EventStreamAsync[models.CreateStreamResponseBody]:
        r"""Create Completion Stream
