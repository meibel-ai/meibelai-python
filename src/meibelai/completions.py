...
class Completions(BaseSDK):
    ...
    def create_stream(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> eventstreaming.EventStream[models.CreateStreamCompletionResponseBody]:
        ...
        if utils.match_response(http_res, "200", "text/event-stream"):
            return eventstreaming.EventStream(
                ...
                lambda raw: utils.unmarshal_json(
                    raw, models.CreateStreamCompletionResponseBody
                ),
                sentinel="[DONE]",
            )
        if utils.match_response(http_res, "422", "application/json"):
    ...
    async def create_stream_async(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> eventstreaming.EventStreamAsync[models.CreateStreamCompletionResponseBody]:
        r"""Create Completion Stream
