...
class MeibelaiContent(BaseSDK):
    ...
    def list_datasource_content(
        ...
        *,
        ...
        :param continuation_token: Token for pagination to get next page of results
    ...
    def trigger_ingest(
        ...
        *,
        ...
        request = models.TriggerIngestRequest(
            datasource_id=datasource_id,
        )
    ...
    async def trigger_ingest_async(
        self,
        *,
        datasource_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
