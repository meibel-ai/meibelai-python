...
with Meibelai() as m_client:
    ...
    res = m_client.dataelements.delete_dataelement(datasource_id=545907, dataelement_id=698486)
...
with Meibelai() as m_client:
    ...
    res = m_client.dataelements.upload_dataelement(datasource_id=403654)
